...
<meta name="description" content="Deploy docker image free hosting, docker playground kubernetes Playground, nginx,wordpress,tomcat,php,joomla">
       ...
       <%
		...
		<div class="radio">
			<label>
				...
				<input id="wordpress" type="radio" name="action" value="wordpress"><img class="img-fluid rounded" src="images/playground/wordpress.png"  alt="mysql deployment Online">
				<input id="joomla" type="radio" name="action" value="joomla"><img class="img-fluid rounded" src="images/playground/joomla.png"  alt="joomla Deployment">
